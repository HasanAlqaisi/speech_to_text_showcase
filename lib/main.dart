...
class _SpeechSampleAppState extends State<SpeechSampleApp> {
      ...
      home: Scaffold(
        body: SafeArea(
          child: Column(children: [
            ...
            // ),
            Expanded(child: SpeechStatusWidget(speech: speech)),
          ]),
        ),
      ),
    );
  ...
  void resultListener(SpeechRecognitionResult result) {
    _logEvent(
        'Result listener final: ${result.finalResult}, confidence: ${result.confidence}');
    setState(() {
      lastWords =
          '${result.recognizedWords} - ${result.confidence.toStringAsFixed(2)}';
    });
  }
